...
import IngestionModeTiles from '/connectors/ingestion-modes-tiles.mdx'
...
<IngestionModeTiles yamlPath="/connectors/api/rest/yaml" />

{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/api/rest/yaml"} /%}
...
<MetadataIngestionUi connector={"VertexAI"} selectServicePath={"/images/connectors/rest/select-service.png"} addNewServicePath={"/images/connectors/rest/add-new-service.png"} serviceConnectionPath={"/images/connectors/rest/service-connection.png"} />
