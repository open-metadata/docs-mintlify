...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/athena/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/athena/reverse-metadata.mdx" /%}
{% /collateContent %}
