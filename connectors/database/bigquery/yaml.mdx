...
{% partial file="/v1.9/connectors/database/partitioned-tables.mdx" /%}
...
{% partial file="/v1.9/connectors/yaml/common/gcp-config-def.mdx" /%}
...
{% partial file="/v1.9/connectors/yaml/common/gcp-config.mdx" /%}
