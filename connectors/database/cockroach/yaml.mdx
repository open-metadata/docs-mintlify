...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/cockroach/yaml"} /%}
...
{% partial file="/v1.9/connectors/yaml/data-profiler.mdx" variables={connector: "cockroach"} /%}
