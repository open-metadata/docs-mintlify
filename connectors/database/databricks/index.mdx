...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/databricks/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/databricks/reverse-metadata.mdx" /%}
{% /collateContent %}
