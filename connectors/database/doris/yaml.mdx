...
{% partial file="/v1.9/connectors/yaml/data-profiler.mdx" variables={connector: "doris"} /%}

{% partial file="/v1.9/connectors/yaml/auto-classification.mdx" variables={connector: "doris"} /%}
