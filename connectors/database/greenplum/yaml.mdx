...
{% partial file="/v1.9/connectors/yaml/data-profiler.mdx" variables={connector: "greenplum"} /%}

{% partial file="/v1.9/connectors/yaml/auto-classification.mdx" variables={connector: "greenplum"} /%}
...
{% partial file="/v1.9/connectors/yaml/lineage.mdx" variables={connector: "greenplum"} /%}
