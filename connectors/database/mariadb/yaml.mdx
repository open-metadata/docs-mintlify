...
{% partial file="/v1.9/connectors/yaml/lineage.mdx" variables={connector: "mariadb"} /%}

{% partial file="/v1.9/connectors/yaml/data-profiler.mdx" variables={connector: "mariadb"} /%}

{% partial file="/v1.9/connectors/yaml/auto-classification.mdx" variables={connector: "mariadb"} /%}
