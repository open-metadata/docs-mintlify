...
description: 'Connect OpenMetadata to MySQL databases'
---

# MySQL Connector

Connect OpenMetadata to your MySQL databases to extract metadata, lineage, and usage information.

## Prerequisites

- MySQL 5.7 or higher
- User with appropriate permissions
- Network connectivity from OpenMetadata to MySQL
...
```bash
mysql --ssl-mode=REQUIRED -h mysql.company.com -u openmetadata_user -p
```
</Accordion>