...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/oracle/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/oracle/reverse-metadata.mdx" /%}
{% /collateContent %}
