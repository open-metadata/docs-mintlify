...
{% partial file="/v1.9/connectors/yaml/data-profiler.mdx" variables={connector: "oracle"} /%}

{% partial file="/v1.9/connectors/yaml/auto-classification.mdx" variables={connector: "oracle"} /%}

{% partial file="/v1.9/connectors/yaml/data-quality.mdx" /%}

{% partial file="/v1.9/connectors/yaml/lineage.mdx" variables={connector: "oracle"} /%}
