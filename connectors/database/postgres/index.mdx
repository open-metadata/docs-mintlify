...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/postgres/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/postgres/reverse-metadata.mdx" /%}
{% /collateContent %}
