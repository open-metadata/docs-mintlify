...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/salesforce/yaml"} /%}
...
{% partial file="/v1.9/connectors/troubleshooting.mdx" /%}
