...
{% partial file="/v1.9/connectors/yaml/lineage.mdx" variables={connector: "sapHana"} /%}

{% partial file="/v1.9/connectors/yaml/data-profiler.mdx" variables={connector: "sapHana"} /%}

{% partial file="/v1.9/connectors/yaml/auto-classification.mdx" variables={connector: "sapHana"} /%}
