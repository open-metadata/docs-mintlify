...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/snowflake/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/snowflake/reverse-metadata.mdx" /%}
{% /collateContent %}
