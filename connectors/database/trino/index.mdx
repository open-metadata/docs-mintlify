...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/trino/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/trino/reverse-metadata.mdx" /%}
{% /collateContent %}
