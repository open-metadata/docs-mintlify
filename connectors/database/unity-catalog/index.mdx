...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/unity-catalog/yaml"} /%}
...
{% partial file="/v1.9/connectors/database/advanced-configuration.mdx" /%}

{% /extraContent %}

{% partial file="/v1.9/connectors/test-connection.mdx" /%}

{% partial file="/v1.9/connectors/database/configure-ingestion.mdx" /%}

{% partial file="/v1.9/connectors/ingestion-schedule-and-deploy.mdx" /%}

{% /stepsContainer %}

{% collateContent %}
{% partial file="/v1.9/connectors/database/unitycatalog/reverse-metadata.mdx" /%}
{% /collateContent %}
