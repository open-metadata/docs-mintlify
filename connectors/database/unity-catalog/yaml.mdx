...
{% partial file="/v1.9/connectors/yaml/query-usage.mdx" variables={connector: "unitycatalog"} /%}

{% partial file="/v1.9/connectors/yaml/lineage.mdx" variables={connector: "unitycatalog"} /%}
