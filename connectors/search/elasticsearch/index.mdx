...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/search/elasticsearch/yaml"} /%}
...
{% partial file="/v1.9/connectors/search/configure-ingestion.mdx" /%}
