...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/storage/adls/yaml"} /%}
...
{% partial file="/v1.9/connectors/storage/configure-ingestion.mdx" /%}
