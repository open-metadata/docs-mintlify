...
<CardGroup cols={3}>
  <Card title="Type Safe" icon="shield-check" color="#16a34a">
    Generated from API schemas for type safety
  </Card>
  <Card title="Full Featured" icon="star" color="#f59e0b">
    Complete API coverage and authentication
  </Card>
  <Card title="Production Ready" icon="building" color="#3b82f6">
...
<CardGroup cols={3}>
  ...
  <Card title="Java SDK" icon="java" href="/sdk/java/overview">
    Enterprise Java integration
  </Card>
  <Card title="Go SDK" icon="go" href="/sdk/go/overview">
