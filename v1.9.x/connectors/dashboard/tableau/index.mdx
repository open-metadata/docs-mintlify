...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/dashboard/tableau/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/dashboard/tableau/reverse-metadata.mdx" /%}
{% /collateContent %}
