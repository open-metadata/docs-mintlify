...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/bigquery/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/bigquery/reverse-metadata.mdx" /%}
{% /collateContent %}
