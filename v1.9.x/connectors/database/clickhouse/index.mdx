...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/clickhouse/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/clickhouse/reverse-metadata.mdx" /%}
{% /collateContent %}
