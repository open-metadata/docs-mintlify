...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/mssql/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/mssql/reverse-metadata.mdx" /%}
{% /collateContent %}
