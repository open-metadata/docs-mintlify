...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/mysql/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/mysql/reverse-metadata.mdx" /%}
{% /collateContent %}
