...
{% partial file="/v1.9/connectors/yaml/data-profiler.mdx" variables={connector: "presto"} /%}

{% partial file="/v1.9/connectors/yaml/auto-classification.mdx" variables={connector: "presto"} /%}
