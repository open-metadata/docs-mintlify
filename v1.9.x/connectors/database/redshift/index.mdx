...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/database/redshift/yaml"} /%}
...
{% collateContent %}
{% partial file="/v1.9/connectors/database/redshift/reverse-metadata.mdx" /%}
{% /collateContent %}
