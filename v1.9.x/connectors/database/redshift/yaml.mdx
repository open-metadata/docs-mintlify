...
{% partial file="/v1.9/connectors/yaml/query-usage.mdx" variables={connector: "redshift"} /%}

{% partial file="/v1.9/connectors/yaml/lineage.mdx" variables={connector: "redshift"} /%}

{% partial file="/v1.9/connectors/yaml/data-profiler.mdx" variables={connector: "redshift"} /%}

{% partial file="/v1.9/connectors/yaml/auto-classification.mdx" variables={connector: "redshift"} /%}
