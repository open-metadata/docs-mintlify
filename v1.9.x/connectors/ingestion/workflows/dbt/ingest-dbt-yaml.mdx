...
{% partial file="/v1.9/connectors/yaml/dbt/dbt-prefix-def.mdx" /%}

{% partial file="/v1.9/connectors/yaml/dbt/source-config-def.mdx" /%}
...
{% partial file="/v1.9/connectors/yaml/dbt/dbt-prefix.mdx" /%}

{% partial file="/v1.9/connectors/yaml/dbt/source-config.mdx" /%}
