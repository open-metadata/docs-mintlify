...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/messaging/redpanda/yaml"} /%}
...
{% partial file="/v1.9/connectors/messaging/configure-ingestion.mdx" /%}
