...
{% partial file="/v1.9/connectors/ingestion-modes-tiles.mdx" variables={yamlPath: "/connectors/ml-model/sagemaker/yaml"} /%}
...
{% partial file="/v1.9/connectors/ml-model/configure-ingestion.mdx" /%}
