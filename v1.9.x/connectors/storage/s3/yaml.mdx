...
{% partial file="/v1.9/connectors/storage/manifest.mdx" /%}
...
{% partial file="/v1.9/connectors/yaml/storage/source-config-def.mdx" /%}
...
{% partial file="/v1.9/connectors/yaml/storage/source-config.mdx" /%}
